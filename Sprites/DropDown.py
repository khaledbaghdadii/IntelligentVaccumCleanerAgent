...
class DropDown:
    ...
    def __init__(self, x, y, w, h,  main, options,color_menu=[COLOR_INACTIVE,COLOR_ACTIVE], color_option=[COLOR_LIST_INACTIVE,COLOR_LIST_ACTIVE],font=pg.font.SysFont(None, 20),):
